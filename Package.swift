...
let assertServices = add(moduleName: "AssertServices", includesTest: false, swiftLanguageMode: .v5)
...
let core = add(moduleName: "Core", dependencies: [assertServices, infoPListChecker], includesTest: true, swiftLanguageMode: .v5)
