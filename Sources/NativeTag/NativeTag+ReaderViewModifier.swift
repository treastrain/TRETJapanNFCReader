...
extension NativeTag.ReaderViewModifier {
    private final class Object {
        typealias TagType = NativeTag
        private var reader: Reader?
        private var currentTask: Task<(), Never>?
        
        func read(taskPriority: TaskPriority?, detectingAlertMessage: String, onBeginReadingError: @escaping @Sendable (Error) -> Void, didBecomeActive: @escaping @Sendable (NativeTag.Reader.AfterBeginProtocol) async -> Void, didInvalidate: @escaping @Sendable (NFCReaderError) -> Void, didDetect: @escaping @Sendable (Reader.ReaderProtocol, NativeTag.ReaderDetectObject) async throws -> NativeTag.DetectResult) {
            cancel()
