//
//  LocalTransitICCardDataResponse.swift
//  TRETJapanNFCReader
//
...
@available(iOS 13.0, *)
public struct LocalTransitICCardDataResponse: FeliCaReadWithoutEncryptionResponse {
    public let cardData: LocalTransitICCardData
